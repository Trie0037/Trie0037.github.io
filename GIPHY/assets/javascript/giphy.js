...
/*var topics = [{
    "Superheroes": "",//would like to be able to add any superhero if possible
}]

function topicButtons() {

    // Deletes the superheroes prior to adding new superheroes
...
/*$("button").on("click", function () {
    ...
    var queryURL = "https://api.giphy.com/v1/gifs/search?q=" +
        person + "&api_key=XOENw94Vovq4Mjfk4D0WUe1j6b8qP1Cn&limit=10";
